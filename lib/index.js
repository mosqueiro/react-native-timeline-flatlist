          ...
          {[25, 26].includes(rowData.type) ? (
            ...
            <React.Fragment>
              <Text style={[this.props.darkMode ? stylesDark.value : styles.value]}>
                ...
                {[25, 26].includes(rowData.type) ? "ZEFI" : [19, 23, 24].includes(rowData.type) ? "BRL" : rowData.type === 14 ? "" : [9, 11, 13, 15].includes(rowData.type) || rowData.transaction_type === "chargeback" ? "BRL" : rowData.type === 6 && rowData.stage === 2 && !rowData.is_all ? "zvZEFI" : rowData.stage === 2 || rowData.type === 17 ? rowData.coin.symbol2 : rowData.coin.symbol}
